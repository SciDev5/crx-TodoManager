...
class Translate extends React.Component {
     ...
     * @param {{[key:string]:import("./lang").LangComponent}} [sub] The subsitutions into the text to use (prefix with TODO (something) to auto-translate it) */
    static text(text,sub) { return lang.translate(text,sub); }
    render() {
